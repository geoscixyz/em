...
.. topic :: Prelude
        ...
        planned for the future. The case study is based on the extended
        abstract "From exploration to reclamation: using EM methods at SAGD
        sites in the Athabasca oil sands" :cite:`DevrieseOldenburg2016a`. The
        readers can anticipate to learn the following:
