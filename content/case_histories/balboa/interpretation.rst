...
:numref:`bboa_interp` a presents the Balboa deposit cross-section from diamond drilling (after
:cite:`burge2014`), showing the 0.4% copper ore shell and the sulphide shells
...
section for L1170, using the Geosoft MVI 3D inversion code :cite:`ellis2012`,
which accounts for magnetic remanence. The section shows that Balboa occurs in
