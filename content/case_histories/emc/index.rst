...
- "Numerical modeling of Z-TEM (airborne AFMAG) responses to guide exploration strategies" :cite:`lo08`

- "Three-dimensional inversion of ZTEM data" :cite:`holtham10`

- "Structure of the Dixie Valley Geothermal System, a "typical" Basin and Range geothermal system, from thermal and gravity data" :cite:`blackwell99`

- "Structure of the Inter-Basin Transition Zone between Dixie Valley and Fairview Valley, Nevada, USA" :cite:`mankhemthong08`
