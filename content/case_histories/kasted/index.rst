...
Thanks to SkyTEM for permission to reproduce figures and adapt text from the source material. This case study was adapted from the articles "A regional scale hydrostratigraphy generated from geophysical data of varying age, type and quality" by :cite:`Vilhelmsen2016` and "3D geological modelling of a complex buried-valley network delineated from borehole and AEM data" by :cite:`Hoyer2015`.
