...
.. topic :: Prelude
    ...
    This case history is based upon the paper `"Assessment of near-surface mapping capabilities by airborne transient electromagnetic data - an extensive comparison to conventional borehole data" <http://www.hgg.geo.au.dk/ref_manager/SCHAMPER2014A.pdf>`__ by Schamper (:cite:`Schamper2014`). 
