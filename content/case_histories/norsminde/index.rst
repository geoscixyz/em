...
.. topic :: Prelude
     ...
     This case history follows the use of the SkyTEM airborne system to model and estimate the nitrate reduction in shallow aquifers near Norsminde, Denmark.

**Special Thanks**

Thanks to SkyTEM and the Journal of Applied Geophysics for permission to reproduce figures and adapt text from the source material. This case history was adapted from the paper `"Assessment of near-surface mapping capabilities by airborne transient electromagnetic data - an extensive comparison to conventional borehole data" <http://www.hgg.geo.au.dk/ref_manager/SCHAMPER2014A.pdf>`__ by Schamper (:cite:`Schamper2014`).
