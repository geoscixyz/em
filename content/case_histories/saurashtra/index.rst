...
- **Authors**: Strack, K. M. and Pandey, P. B.
- **Editors**: :ref:`dccowan` and :ref:`doldenburg`


.. topic :: Prelude

    This case history describes the use of long-offset time-domain electromagnetic surveying (LOTEM) to penetrate thick basaltic cover and image hydrocarbon-bearing sediments in the Saurashtra basin, India.
