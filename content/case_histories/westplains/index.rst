...
- **Authors**: :ref:`mikemcm`, Christoph Schwarzbach, Eldad Haber, and :ref:`doldenburg`
- **Editor**: :ref:`dccowan`
...
Thanks to the `Society of Exploration Geophysicists <http://seg.org>`__ for permission to reproduce figures and adapt text from:
    ...
    - Michael S. McMillan, Christoph Schwarzbach, Eldad Haber, and Douglas W. Oldenburg (2015). ”3D parametric hybrid inversion of time-domain airborne electromagnetic data.” GEOPHYSICS, 80(6), K25-K36. `https://doi.org/10.1190/geo2015-0141.1 <https://doi.org/10.1190/geo2015-0141.1>`__
...
.. figure:: images/thumbnail_westplains.png
    :align: right
    :figwidth: 50%
    :name: figthumbnail_westplains_index
