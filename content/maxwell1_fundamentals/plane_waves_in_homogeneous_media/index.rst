...
Here, the properties of plane waves in homogeneous media are presented in both the time domain and the frequency domain. In each case, the fundamental physics are provided. For :ref:`plane waves in the frequency domain<frequency_domain_plane_wave_sources_index>`, you will learn about:
...
For :ref:`plane waves in the time domain<time_domain_plane_wave_sources_index>`, you will learn about:
