...
.. Purpose::
        ...
        Here, expressions from Wait (:cite:`Wait1951`) are presented for predicting the dipole response from a conductive and magnetically permeable sphere in free-space.
...
To approximate the sphere's response, Wait (:cite:`Wait1951`) considered the dipole response from a conductive and magnetically permeable sphere under the influence of a spatially uniform, harmonic field (:numref:`DipoleField`).
...
An explicit expression for the excitation factor is given by (:cite:`Wait1951`):
