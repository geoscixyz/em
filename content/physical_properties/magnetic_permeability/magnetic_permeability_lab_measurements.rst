...
.. figure:: ./figures/figPermeabilityVsRes.png
	:align: center
        ...
        Representation of an experimentally derived curve which characterizes an empirical relationship between :math:`\mu_s` and :math:`\omega_r` for a particular machine.
